...
var category = {OBJ: $("#_JD_ALLSORT"),
		//URL_Serv: "http://localhost:8083/rest/item/cat/all?callback=category.getDataService",
//		URL_Serv: "http://localhost:8082/category.json",
		URL_Serv: "http://localhost:8083/item/cat/all.action",
...
//    	$.getJSON(this.URL_Serv, category.getDataService)
