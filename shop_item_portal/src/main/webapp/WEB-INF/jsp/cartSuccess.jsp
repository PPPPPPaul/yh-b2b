...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
   ...
   <script type="text/javascript">
		function goCartList(){
			//window.location.href="${page.request.contextPath}/cart/list.html";
...
<div class="w" id="headers">
		<div id="logo"><a href="http://www.jd.com/"><img alt="霞飞商城" src="/images/xiafei-logo.gif"></a></div>
...
<div class="w main">
	<div class="m m3 msop">
		...
		<div class="mc" id="success_detail">	
		    <ul class="list-order">
			    <li class="li-st">
					<div class="fore1">继续购物：<a href="javascript:void(0)"></a></div>
					<!-- 货到付款 -->
					<div class="fore2"><a href="javascript:goCartList();">去购物车结算</a><strong class="ftx-01"></strong></div>
					<div class="fore3">
					   	霞飞快递 &nbsp; 送货时间: 预计  送达&nbsp;
					</div>
				</li>
